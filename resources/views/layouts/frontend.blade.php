...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed page-loading">
		<!--begin::Main-->
		<!--begin::Header Mobile-->
		<div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed" style="background: #9932CC">
			<!--begin::Logo-->
			<a href="/">
				{{-- <img alt="Logo" src="{{ asset('images')}}/logo.png" class="max-h-100px" /> --}}
				<h3 class="text-white">{{ config('app.name', 'PPOB') }}</h3>
            </a>
            <div>
            <h3 class="text-white w-auto d-flex align-items-center"> Saldo Anda : RP.
                @guest
                    {{number_format('0',2,',','.')}}
                @else
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div id="kt_header" class="header flex-column header-fixed">
						<!--begin::Top-->
						<div class="header-top" style="background: #9932CC">
							<!--begin::Container-->
							<div class="container">
								<div class="d-none d-lg-flex align-items-center mr-3">
									<a href="{{ url('/') }}" class="mr-20">
										{{-- <img alt="Logo" src="{{ asset('images')}}/logo.png" class="max-h-130px" /> --}}
										<h3 class="text-white">{{ config('app.name', 'PPOB') }}</h3>
									</a>
								</div>
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white w-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
											...
											<span class="symbol symbol-35">
												<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-30" style="background-image:url('@if(Auth::user()->avatar != NULL) {{  asset('images/avatar/'.Auth::user()->avatar) }} @else {{  asset('/images/user.jpg') }} @endif')"></span>
											</span>
										</div>
									</div>
									<!--end::User-->
									...
									<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
										...
										<ul class="menu-nav">
											...
											<li class="menu-item menu-item-submenu menu-item-rel" >
                                                <div class="symbol">
                                                    <img alt="Pic" src="{{ asset('images')}}/pulsa.png"/>
                                                </div>
											...
											<li class="menu-item menu-item-submenu menu-item-rel" >
                                                <div class="symbol">
                                                    <img alt="Pic" src="{{ asset('images')}}/paket-data.jpg"/>
                                                </div>
											...
											<li class="menu-item menu-item-submenu menu-item-rel" >
                                                <div class="symbol">
                                                    <img alt="Pic" src="{{ asset('images')}}/pln.png"/>
                                                </div>
											...
											<li class="menu-item menu-item-submenu menu-item-rel" >
                                                <div class="symbol">
                                                    <img alt="Pic" src="{{ asset('images')}}/reward.png"/>
                                                </div>
											...
											<li class="menu-item menu-item-submenu menu-item-rel" >
                                                <div class="symbol">
                                                    <img alt="Pic" src="{{ asset('images')}}/history.png"/>
                                                </div>
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="#" class="text-dark-75 text-hover-primary">{{ config('app.name', 'PPOB') }}</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('@if(Auth::user()->avatar != NULL) {{  asset('images/avatar/'.Auth::user()->avatar) }} @else {{  asset('/images/user.jpg') }} @endif')"></div>
		...
		<script>
			...
			var saldo = {!! json_encode(Auth::user()->saldo) !!};
			if (role == 'outlet') {
				if(saldo < 100000){
					swal("Harap Segera Mengisi Saldo Anda!", "Saldo anda kurang dari minimal yaitu Rp. 100.000!", "info");
				}
			}
		</script>
		@yield('js')
