                        ...
                        <div class="mb-3">
                            <form method="POST" action="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input id="nominal" type="number" class="form-control" name="nominal" min="0" value="{{ $pulsa_nominal->nominal }}" autocomplete="nominal" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input id="fixed_price" type="number" class="form-control" name="fixed_price" min="0" value="{{ $pulsa_nominal->fixed_price }}" autocomplete="fixed_price" autofocus>
                                    </div>
                                </div>
