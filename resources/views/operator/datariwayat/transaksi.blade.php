...
<link rel="stylesheet" href="https://cdn.datatables.net/datetime/1.1.1/css/dataTables.dateTime.min.css">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('Tabel Riwayat Transaksi ') }}</div>
                    <div class="card-body">
                            ...
                            <div class="tab-content mt-4" id="myTabContent">
                                <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                                    ...
                                    <div class="card-footer">
                                        <strong style="font-size: 1.5rem">Total Transaksi Rp. {{ number_format($price,2,',','.') }}</strong>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="month" role="tabpanel" aria-labelledby="month-tab">
                                    ...
                                    <div class="card-footer">
                                        <strong style="font-size: 1.5rem">Total Transaksi Rp. {{ number_format($price_month,2,',','.') }}</strong>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="week" role="tabpanel" aria-labelledby="week-tab">
                                    ...
                                    <div class="card-footer">
                                        <strong style="font-size: 1.5rem">Total Transaksi Rp. {{ number_format($price_week,2,',','.') }}</strong>
                                    </div>
                                </div>
                        </div>
                    </div>
